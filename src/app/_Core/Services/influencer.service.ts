...
export class InfluencerService {
  ...
  deleteAdmin(id: any) {
    ...
    headers = headers.append('Accept', 'application/json');
    return this.http
      .delete<any>(`${environment.apiUrl}influencer/${id}`, {
        headers: headers,
      })
      .pipe(
        map((result: any) => {
  ...
  markStatusAdmin(id: any, formData: any) {
    ...
    headers = headers.append('Accept', 'application/json');
    return this.http
      .patch<any>(`${environment.apiUrl}influencer/mark-status/${id}`, formData, {
        headers: headers,
      })
      .pipe(
        map((result: any) => {
  ...
  //   headers = headers.append('Accept', 'application/json');
  //   return this.http
  //     .patch<any>(`${environment.apiUrl}influencer/profile-upload/${id}`, formData, {
  //       headers: headers,
  //     })
  //     .pipe(
  //       map((result: any) => {
